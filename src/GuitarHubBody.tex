...
{\makeatletter\def\SB@ellipspread#1#2{\begin{flushleft}- #1\par\end{flushleft}}\showindex[2]{Canti per la Liturgia, per le Celebrazioni e per la Preghiera}{chiesa}} 
{\makeatletter\def\SB@ellipspread#1#2{\begin{flushleft}- #1\par\end{flushleft}}\showindex[2]{Jukebox}{jukebox}} 
{\makeatletter\def\SB@ellipspread#1#2{\begin{flushleft}- #1\par\end{flushleft}}\showindex[2]{Christmas}{christmas}} 

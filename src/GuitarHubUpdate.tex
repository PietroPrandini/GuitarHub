...
\begin{document}
  \includepdf[pages={6,66,91,{}},nup=1x2,landscape]{../GuitarHubAlphabeticNoteNames.pdf}
  \includepdf[pages={4,43,62,{}},nup=1x2,landscape]{../GuitarHubLyrics.pdf}
  \includepdf[pages={6,66,91,{}},nup=1x2,landscape]{../GuitarHubSolfegeNoteNames.pdf}
\end{document}

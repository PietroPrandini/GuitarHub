...
\begin{document}
  \includepdf[pages={71,72},nup=1x2,landscape]{../GuitarHubAlphabeticNoteNames.pdf}
  %\includepdf[pages={{},25},nup=1x2,landscape]{../GuitarHubLyrics.pdf}
  \includepdf[pages={71,72},nup=1x2,landscape]{../GuitarHubSolfegeNoteNames.pdf}
\end{document}

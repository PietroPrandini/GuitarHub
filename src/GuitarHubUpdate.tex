...
\begin{document}
  \includepdf[pages={6,101},nup=1x2,landscape]{../GuitarHubAlphabeticNoteNames.pdf}
  \includepdf[pages={5,70},nup=1x2,landscape]{../GuitarHubLyrics.pdf}
  \includepdf[pages={6,101},nup=1x2,landscape]{../GuitarHubSolfegeNoteNames.pdf}
\end{document}

...
\begin{document}
  \includepdf[pages={121,122},nup=1x2,landscape]{../GuitarHubAlphabeticNoteNames.pdf}
  %\includepdf[pages={5,66},nup=1x2,landscape]{../GuitarHubLyrics.pdf}
  \includepdf[pages={121,122},nup=1x2,landscape]{../GuitarHubSolfegeNoteNames.pdf}
\end{document}

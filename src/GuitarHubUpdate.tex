...
\begin{document}
  \includepdf[pages={6,32},nup=1x2,landscape]{../GuitarHubAlphabeticNoteNames.pdf}
  \includepdf[pages={5,24},nup=1x2,landscape]{../GuitarHubLyrics.pdf}
  \includepdf[pages={6,32},nup=1x2,landscape]{../GuitarHubSolfegeNoteNames.pdf}
\end{document}

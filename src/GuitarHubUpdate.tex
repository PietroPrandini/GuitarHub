...
\begin{document}
  \includepdf[pages={{},19},nup=1x2,landscape]{../GuitarHubAlphabeticNoteNames.pdf}
  \includepdf[pages={{},15},nup=1x2,landscape]{../GuitarHubLyrics.pdf}
  \includepdf[pages={{},19},nup=1x2,landscape]{../GuitarHubSolfegeNoteNames.pdf}
\end{document}

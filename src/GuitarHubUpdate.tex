...
\begin{document}
  \includepdf[pages={70,71},nup=1x2,landscape]{../GuitarHubAlphabeticNoteNames.pdf}
  \includepdf[pages={{},46},nup=1x2,landscape]{../GuitarHubLyrics.pdf}
  \includepdf[pages={70,71},nup=1x2,landscape]{../GuitarHubSolfegeNoteNames.pdf}
\end{document}

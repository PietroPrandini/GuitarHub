...
\begin{document}
  \includepdf[pages={62,63},nup=1x2,landscape]{../GuitarHubAlphabeticNoteNames.pdf}
  \includepdf[pages={{},41},nup=1x2,landscape]{../GuitarHubLyrics.pdf}
  \includepdf[pages={62,63},nup=1x2,landscape]{../GuitarHubSolfegeNoteNames.pdf}
\end{document}

...
\begin{document}
  \includepdf[pages={4,91,92,93,118,119,156},nup=1x2,landscape]{../GuitarHubAlphabeticNoteNames.pdf}
  \includepdf[pages={4,{}},nup=1x2,landscape]{../GuitarHubLyrics.pdf}
  \includepdf[pages={4,91,92,93,118,119,156},nup=1x2,landscape]{../GuitarHubSolfegeNoteNames.pdf}
\end{document}

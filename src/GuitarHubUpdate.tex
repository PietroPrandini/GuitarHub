...
\begin{document}
  \includepdf[pages={6,27},nup=1x2,landscape]{../GuitarHubAlphabeticNoteNames.pdf}
  \includepdf[pages={5,21},nup=1x2,landscape]{../GuitarHubLyrics.pdf}
	\includepdf[pages={6,27},nup=1x2,landscape]{../GuitarHubSolfegeNoteNames.pdf}
\end{document}

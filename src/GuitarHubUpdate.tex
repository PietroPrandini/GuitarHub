...
\begin{document}
  \includepdf[pages={5,10,11,{}},nup=1x2,landscape]{../GuitarHubAlphabeticNoteNames.pdf}
  %\includepdf[pages={5,79},nup=1x2,landscape]{../GuitarHubLyrics.pdf}
  \includepdf[pages={5,10,11,{}},nup=1x2,landscape]{../GuitarHubSolfegeNoteNames.pdf}
\end{document}

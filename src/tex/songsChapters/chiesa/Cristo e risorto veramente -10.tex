...
,cr={\centering{\href{https://github.com/PietroPrandini/GuitarHub}{https://github.com/PietroPrandini/GuitarHub} - \href{http://creativecommons.org/licenses/by-sa/4.0/}{CC-BY-SA} - \filemodprintdate{"tex/songsBodies/Cristo e risorto veramente.tex"}}}, % Copyright information
...
%\capo{0}
\transpose{2} % Automatic transpositions from +0 to +12 semitones

\input{"tex/songsBodies/Cristo e risorto veramente.tex"}

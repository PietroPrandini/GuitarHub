...
\begin{smallsong}\begin{twocolssong}
\beginsong{Nozze a Cana}[
%by={%Authors, composers, and other contributors}
,cr={\centering{\href{https://github.com/PietroPrandini/GuitarHub}{https://github.com/PietroPrandini/GuitarHub}\\\href{http://creativecommons.org/licenses/by-sa/4.0/}{\textbf{CC BY-SA}} Pietro Prandini 2018-2024}}
...
\input{"tex/songs/Nozze a Cana.tex"}

\endsong
\end{twocolssong}\end{smallsong}

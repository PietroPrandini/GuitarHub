...
%	if the song is over 1 page
%\renewcommand{\lyricfont}{\small}
%\renewcommand{\printchord}[1]{\bf#1\small}

\beginsong{%Title
Io ho scelto te}[
by={I for Worship} % Authors, composers, and other contributors
,cr={\centering{\href{https://github.com/PietroPrandini/GuitarHub}{https://github.com/PietroPrandini/GuitarHub}\\\href{http://creativecommons.org/licenses/by-sa/4.0/}{\textbf{CC BY-SA}} 2018-2021}}, % Copyright information
...
\input{"tex/songs/Io ho scelto te.tex"}

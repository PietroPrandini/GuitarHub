...
\begin{twocolssong}
\beginsong{Canterò del tuo amor per sempre}[
%by={%Authors, composers, and other contributors}
,cr={\centering{\href{https://github.com/PietroPrandini/GuitarHub}{https://github.com/PietroPrandini/GuitarHub}\\\href{http://creativecommons.org/licenses/by-sa/4.0/}{\textbf{CC BY-SA}} Maria Zardini 2018-2024}}
...
\input{"tex/songs/Cantero del tuo amor per sempre.tex"}
